            ...
            <div class="services_section_2">
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="<?php echo get_theme_file_uri("images/icon-1.png") ?>"></div> 
                        <div class="app_icon_1"><img src="<?php echo get_theme_file_uri("images/icon-1.png") ?> "></div>
                        <h4 class="services_text active">App Design</h4>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="<?php echo get_theme_file_uri("images/icon-2.png") ?>"></div>
                        <div class="app_icon_1"><img src="<?php echo get_theme_file_uri("images/icon-6.png") ?>"></div>
                        <h4 class="services_text">Website Design</h4>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="<?php echo get_theme_file_uri("images/icon-3.png") ?>"></div>
                        <div class="app_icon_1"><img src="<?php echo get_theme_file_uri("images/icon-7.png") ?>"></div>
                        <h4 class="services_text">Html And Css</h4>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="<?php echo get_theme_file_uri("images/icon-4.png") ?>"></div>
                        <div class="app_icon_1"><img src="<?php echo get_theme_file_uri("images/icon-8.png") ?>"></div>
            ...
            <div class="portfolio_section">
                  ...
                  <div class="row">
                     <div class="col-md-8">
                        <div class="container_main">
                           <img src="<?php echo get_theme_file_uri("images/img-1.png") ?>" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="<?php echo get_theme_file_uri("images/img-2.png") ?>" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
               ...
               <div class="portfolio_section_2">
                  <div class="row">
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="<?php echo get_theme_file_uri("images/img-3.png") ?>" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="<?php echo get_theme_file_uri("images/img-4.png") ?>" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="<?php echo get_theme_file_uri("images/img-5.png") ?>" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
